/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e3abc3d2290776be7ec20fca7abaeb84)
// Runtime types generated with workerd@1.20260520.1 2026-06-19 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	AUTH_CACHE: KVNamespace;
	AUTH_BACKUP_BUCKET: R2Bucket;
	AUTH_DB: D1Database;
	OTP_QUEUE: Queue;
	AUDIT_QUEUE: Queue;
	BACKUP_QUEUE: Queue;
	PROJECT_DISPLAY_NAME: "Irwan Motor";
	AUTH_SERVICE_KEY: "irwanmotor-auth";
	AUTH_SERVICE_NAME: "Irwan Motor Auth";
	ACCESS_TOKEN_TTL_SECONDS: "900";
	REFRESH_TOKEN_TTL_DAYS: "30";
	OTP_TTL_SECONDS: "300";
	OTP_MAX_ATTEMPTS: "5";
	OTP_RESEND_COOLDOWN_SECONDS: "60";
	AUTH_ISSUER: "http://localhost:8787";
	AUTH_AUDIENCE: "irwanmotor-services";
	...
	GOWA_API_TOKEN: string;
	AUTH_RATE_LIMITER: DurableObjectNamespace<import("./src/index").RateLimitDO>;
	AUTH_SESSION_GUARD: DurableObjectNamespace<import("./src/index").SessionGuardDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RateLimitDO" | "SessionGuardDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROJECT_DISPLAY_NAME" | "AUTH_SERVICE_KEY" | "AUTH_SERVICE_NAME" | "ACCESS_TOKEN_TTL_SECONDS" | "REFRESH_TOKEN_TTL_DAYS" | "OTP_TTL_SECONDS" | "OTP_MAX_ATTEMPTS" | "OTP_RESEND_COOLDOWN_SECONDS" | "AUTH_ISSUER" | "AUTH_AUDIENCE" | "GOWA_API_BASE" | "PASSWORD_PBKDF2_ITERATIONS" | "ENABLE_ADMIN_SEED" | "ENABLE_DIRECT_OTP_FALLBACK" | "PERMISSION_CACHE_TTL_SECONDS" | "SESSION_CACHE_TTL_SECONDS" | "OTP_MESSAGE_TEMPLATE" | "CORS_ORIGINS" | "JWT_SECRET" | "REFRESH_TOKEN_PEPPER" | "PASSWORD_PEPPER" | "OTP_PEPPER" | "ADMIN_API_TOKEN" | "GOWA_API_TOKEN">> {}
}
